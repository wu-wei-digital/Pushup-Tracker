...
export default function AchievementsPage() {
  ...
  const getRarityStyles = (rarity: string) => {
    const styles: Record<string, string> = {
      ...
      uncommon: "border-green-300 bg-green-50 dark:border-green-600 dark:bg-green-900/20",
      ...
      legendary: "border-amber-300 bg-amber-50 dark:border-amber-600 dark:bg-amber-900/20",
    };
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {BADGE_DEFINITIONS.filter((b) => !unlockedTypes.has(b.type)).map((badge) => (
            <div
              key={badge.type}
              className="p-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800/50 opacity-60"
            >
