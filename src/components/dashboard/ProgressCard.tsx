...
export default function ProgressCard({ total, goal, progress }: ProgressCardProps) {
  return (
    <Card className="relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-32 h-32 bg-sage-100 dark:bg-sage-800/30 rounded-full -translate-y-1/2 translate-x-1/2" />
      ...
      <div className="relative">
        ...
        <div className="mt-4 flex items-end justify-between">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-sage-600 dark:text-sage-300">
              {progress.toFixed(1)}%
            </p>
        ...
        {progress >= 100 && (
          <div className="mt-4 p-3 bg-sage-100 dark:bg-sage-800/50 rounded-lg text-center">
